...
OPTION(client_mount_timeout, OPT_DOUBLE, 10000.0)
...
OPTION(osd_pool_default_erasure_code_directory, OPT_STR, "/erasure-code") // default for the erasure-code-directory=XXX property of osd pool create
