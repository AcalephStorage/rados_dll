...
all: $(BIN)/rados_client.exe $(BIN)/rbd.dll
...
$(BUILD)/%.o:$(CEPH_SRC)/erasure-code/%.cc
	$(CPP) -c $(CPPFLAGS) $^ -o $@
$(BUILD)/%.o:$(CEPH_SRC)/librbd/%.cc
	$(CPP) -c $(CPPFLAGS) $^ -o $@


RBD_OBJECTS=  ./$(BUILD)/librbd.o ./$(BUILD)/AioCompletion.o ./$(BUILD)/AioRequest.o ./$(BUILD)/AsyncFlattenRequest.o ./$(BUILD)/AsyncObjectThrottle.o \
 ./$(BUILD)/AsyncOperation.o ./$(BUILD)/AsyncRequest.o ./$(BUILD)/AsyncResizeRequest.o ./$(BUILD)/AsyncTrimRequest.o ./$(BUILD)/CopyupRequest.o ./$(BUILD)/ImageCtx.o \
 ./$(BUILD)/LibrbdWriteback.o ./$(BUILD)/WatchNotifyTypes.o ./$(BUILD)/ObjectMap.o  ./$(BUILD)/Mutex.o ./$(BUILD)/Thread.o ./$(BUILD)/Throttle.o \
 ./$(BUILD)/hash.o  ./$(BUILD)/snap_set_diff.o  ./$(BUILD)/librados.o  ./$(BUILD)/IoCtxImpl.o  ./$(BUILD)/RadosClient.o  ./$(BUILD)/RadosXattrIter.o \
...
RADOS_OBJECTS=  ./$(BUILD)/hash.o  ./$(BUILD)/snap_set_diff.o  ./$(BUILD)/librados.o  ./$(BUILD)/IoCtxImpl.o  ./$(BUILD)/RadosClient.o  ./$(BUILD)/RadosXattrIter.o \
 ./$(BUILD)/Objecter.o  ./$(BUILD)/MonClient.o  ./$(BUILD)/CrushWrapper.o   ./$(BUILD)/MonMap.o   ./$(BUILD)/CephxAuthorizeHandler.o  ./$(BUILD)/CephxKeyServer.o  ./$(BUILD)/CephxServiceHandler.o \
   ./$(BUILD)/mdstypes.o  ./$(BUILD)/assert.o  ./$(BUILD)/Pipe.o  ./$(BUILD)/admin_socket.o  ./$(BUILD)/Elector.o  ./$(BUILD)/Paxos.o \
  ./$(BUILD)/MDSMap.o  ./$(BUILD)/ceph_argparse.o  ./$(BUILD)/OSDMap.o  ./$(BUILD)/admin_socket_client.o   ./$(BUILD)/MonitorStore.o  ./$(BUILD)/MonMapMonitor.o  ./$(BUILD)/PaxosService.o \
 ./$(BUILD)/entity_name.o   ./$(BUILD)/ceph_context.o  ./$(BUILD)/CephxClientHandler.o  ./$(BUILD)/TextTable.o ./$(BUILD)/util.o \
